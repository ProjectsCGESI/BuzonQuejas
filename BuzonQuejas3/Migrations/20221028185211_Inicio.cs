        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NombreQuejante = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Direccion = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Telefono = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Correo = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    MotivoQueja = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    RelatoHechos = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    ServidorInvolucrado = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ...
                    AtendidoPor = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Resolucion = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    DepartamentoID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MunicipioID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UnidadAdministrativaID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CentroTrabajoID = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("9fc2cce1-f9f0-4010-a043-1ef31ebc5ca0"), "SANTIAGO MIAHUATLAN" },
                    ...
                    { new Guid("0b9af652-e4cb-4b88-a2da-3df709488ce2"), "SAN SEBASTIAN TLACOTEPEC" },
                    { new Guid("071dc637-57e0-4f94-89f4-d2200840d84d"), "SANTA CATARINA TLALTEMPAN" },
                    { new Guid("e05d08a9-c3bf-4907-b64f-6966d1b8bab6"), "SANTA INES AHUATEMPAN" },
                    { new Guid("e78781af-ff29-45dc-b39a-74db1f06c521"), "SANTA ISABEL CHOLULA" },
                    { new Guid("5725ad2c-4481-40df-a0bd-0d358f205b5c"), "HUEHUETLAN EL GRANDE" },
                    ...
                    { new Guid("4ef206dd-de20-47f0-9be9-ea382a4b1b28"), "TECOMATLAN" },
                    ...
                    { new Guid("cddce61c-3c5d-49e2-841a-2a805b1d5e6e"), "TEOPANTLAN" },
                    { new Guid("946c022a-8933-4d77-9313-d3e907518684"), "TEOTLALCO" },
                    { new Guid("e05fcf8b-16f2-4b48-b5ec-7364be12d24a"), "TEPANCO DE LOPEZ" },
                    { new Guid("4b4bb755-d591-49ad-bfdd-b135b4998278"), "TEPANGO DE RODRIGUEZ" },
                    { new Guid("fd628b6d-0964-4735-a112-d5579943e1fd"), "SANTO TOMAS HUEYOTLIPAN" },
                    { new Guid("a79ca31c-259f-46cf-8fd1-ac31b7f1e3a2"), "SAN NICOLAS DE LOS RANCHOS" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("2f765df8-e46c-4e03-b23b-f24984a8b111"), "QUIMIXTLAN" },
                    { new Guid("367c3734-6864-4801-8dca-161d1f371713"), "RAFAEL LARA GRAJALES" },
                    { new Guid("b28e047d-b3a1-4e24-a414-e6716e37b363"), "LOS REYES DE JUAREZ" },
                    ...
                    { new Guid("dd7e3968-c504-4f96-9a9d-5935a001393a"), "SAN NICOLAS BUENOS AIRES" },
                    { new Guid("838881f6-eb1c-4004-bd14-411e063d657c"), "SAN FELIPE TEPATLAN" },
                    { new Guid("44da0137-6c7d-4cee-9b78-22a170c2687c"), "SAN GREGORIO ATZOMPA" },
                    { new Guid("7982bf83-0074-46fb-9d9b-f7e1ac0ade62"), "SAN JERONIMO TECUANIPAN" },
                    { new Guid("02a51ab7-1217-46a5-9ebe-cd6e34400143"), "SAN JERONIMO XAYACATLAN" },
                    { new Guid("c1ae921b-4deb-4fbf-a0de-4daed33d59c0"), "SAN JOSE CHIAPA" },
                    { new Guid("aa022af9-1364-46dd-9804-15bbf72cfecd"), "SAN JOSE MIAHUATLAN" },
                    ...
                    { new Guid("7b3656fc-abc8-4cce-9d19-65b8f3e6c323"), "SAN MARTIN TOTOLTEPEC" },
                    { new Guid("d14e7485-8fa9-47d4-b684-e96fca467e21"), "SAN MATIAS TLALANCALECA" },
                    { new Guid("db092b2f-d154-40d9-a49c-f6705910e888"), "SAN MIGUEL IXITLAN" },
                    ...
                    { new Guid("65a9ea6d-0783-4c43-a688-37428acfd2c2"), "XAYACATLAN DE BRAVO" },
                    { new Guid("f9cefc8b-da26-4ec1-9f46-3a240d1d4878"), "XICOTEPEC" },
                    { new Guid("17d251d7-b894-499c-8213-a34700eaee64"), "XICOTLAN" },
                    ...
                    { new Guid("6ca4dbd0-5ea7-4a3d-8169-dfad1f9ba752"), "XOCHITLAN DE VICENTE SUAREZ" },
                    { new Guid("7baa727c-2af9-44a3-a49d-a1366c53a897"), "XOCHITLAN TODOS SANTOS" },
                    { new Guid("e926e7a3-6ab8-493b-b52c-c233a218829b"), "YAONAHUAC" },
                    ...
                    { new Guid("d027d6b9-d21b-4829-ab30-afacf1dc7466"), "ZAPOTITLAN" },
                    { new Guid("a250ea1a-d762-465c-9b45-89c711935787"), "ZAPOTITLAN DE MENDEZ" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("da041bf7-f859-4fec-9c80-43180d90c8fa"), "TEPEYAHUALCO DE CUAUHTEMOC" },
                    { new Guid("cf8eb8cc-3270-4211-89c4-bfab4b117f6b"), "TETELA DE OCAMPO" },
                    { new Guid("730191fe-8d4b-407e-9dfd-f7404e8451ec"), "TETELES DE AVILA CASTILLO" },
                    ...
                    { new Guid("8340602f-711a-467c-8e59-a2abb587b604"), "PAHUATLAN" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("44e4b1a1-4ad2-406c-9c2b-c718609eb12a"), "COXCATLAN" },
                    ...
                    { new Guid("48b1e89c-da02-43c5-aaa1-1866770eb217"), "CUAUTINCHAN" },
                    ...
                    { new Guid("af7b1630-8ba5-4320-9766-898ded1a8dcf"), "ACATLAN" },
                    { new Guid("bfbc011a-1d34-4f65-af7b-166212abd6b9"), "ACATZINGO" },
                    { new Guid("840a9308-ab81-4b01-bc1f-c2e33c8bed69"), "ACTEOPAN" },
                    { new Guid("8c07e9aa-0247-4000-8216-376b650d81a0"), "AHUACATLAN" },
                    { new Guid("823317e0-12de-471e-9f83-ab679882ee8f"), "AHUATLAN" },
                    ...
                    { new Guid("e13c5d9e-cbc0-4e4c-b2fd-cb95644708c2"), "CHIGMECATITLAN" },
                    { new Guid("f12af03b-940f-4e78-a0ee-32164243cf86"), "ALJOJUCA" },
                    { new Guid("d0e4567b-e3f8-4a5f-bae6-f34cd50221d0"), "AMIXTLAN" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("2aebe25a-dbd6-4636-b0e7-5b9c1bc00acb"), "ATZITZIHUACAN" },
                    ...
                    { new Guid("2457aa01-4c63-4f89-ad2d-adf66a05092c"), "JUAN N. MENDEZ" },
                    ...
                    { new Guid("7a139790-eb48-47dc-ae3a-20297745885a"), "MAZAPILTEPEC DE JUAREZ" },
                    ...
                    { new Guid("0ac3f2af-443e-4ec2-bb07-da2f4f8819a5"), "NICOLAS BRAVO" },
                    ...
                    { new Guid("488a103a-b38d-490c-851f-5b8129d25f09"), "IXTACAMAXTITLAN" },
                    ...
                    { new Guid("ae3ce140-fb00-49af-ba1b-0c6b59df34cb"), "ELOXOCHITLAN" },
                    { new Guid("f537cd59-2f47-438c-9e57-ec53ae50fb92"), "EPATLAN" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("cc76e568-d6e7-4f94-b6be-5088091bdc1d"), "GENERAL FELIPE ANGELES" },
                    ...
                    { new Guid("df2a228b-3b08-4810-832b-243eb92b4d1f"), "HUITZILAN DE SERDAN" },
                    ...
                    { new Guid("abae6922-c82a-4641-9400-f6c4e5f6e074"), "HUEHUETLAN EL CHICO" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Usuarios",
                columns: new[] { "UsuarioID", "Activo", "Clave", "Correo", "DepartamentoID", "Nombre", "RolID" },
                values: new object[] { new Guid("1139861b-5044-4257-b89a-db1b5d4402bf"), true, "123", "root@root.com", new Guid("8a8e1e09-f9ce-41cb-b0b2-4ef91f7b4d61"), "root", new Guid("77a225a3-1266-4b1f-b11c-504969afa856") });

            migrationBuilder.InsertData(
                table: "Usuarios",
                columns: new[] { "UsuarioID", "Activo", "Clave", "Correo", "DepartamentoID", "Nombre", "RolID" },
                values: new object[] { new Guid("7467db95-c0a1-41df-a844-bbb00b60b952"), true, "123", "administrador@administrador.com", new Guid("8a8e1e09-f9ce-41cb-b0b2-4ef91f7b4d61"), "Administrador", new Guid("9a39bcce-b092-4f90-9de7-9e0fb2137034") });

            migrationBuilder.InsertData(
                table: "Usuarios",
                columns: new[] { "UsuarioID", "Activo", "Clave", "Correo", "DepartamentoID", "Nombre", "RolID" },
                values: new object[] { new Guid("a22533a6-7621-492c-b10b-a9363668a2f4"), true, "123", "angel@gmail.com", new Guid("8a6aeedd-336d-4e65-bede-b95f4bf83cf5"), "Angel Sayago Arcos", new Guid("a7c2766f-c09e-41a1-b6e4-35aeed3ad8e7") });
