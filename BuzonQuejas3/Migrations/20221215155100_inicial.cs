...
namespace BuzonQuejas3.Migrations
{
    public partial class inicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "UnidadRemitentes",
                columns: table => new
                {
                    UnidadRemitenteID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Nombre = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnidadRemitentes", x => x.UnidadRemitenteID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Usuarios_UnidadRemitentes_UnidadRemitenteID",
                        column: x => x.UnidadRemitenteID,
                        principalTable: "UnidadRemitentes",
                        principalColumn: "UnidadRemitenteID",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApellidoMServidor = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ...
                    NombreAtendio = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ApellidoPAtendio = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ApellidoMAtendio = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Quejas_UnidadRemitentes_UnidadRemitenteID",
                        column: x => x.UnidadRemitenteID,
                        principalTable: "UnidadRemitentes",
                        principalColumn: "UnidadRemitenteID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("a04c1856-54b5-4699-8660-367a5ac5444d"), "Webs" },
            ...
            migrationBuilder.InsertData(
                table: "Medios",
                columns: new[] { "MedioID", "Nombre" },
                values: new object[] { new Guid("acfca6b3-1cd0-4f6e-a299-685d9ee6a6ee"), "Presencial" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("a7c2766f-c09e-41a1-b6e4-35aeed3ad8e7"), "UnidadRemitente" },
            ...
            migrationBuilder.InsertData(
                table: "UnidadRemitentes",
                columns: new[] { "UnidadRemitenteID", "Nombre" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                table: "Usuarios",
                columns: new[] { "UsuarioID", "Activo", "Clave", "Correo", "Nombre", "RolID", "UnidadAdministrativaID", "UnidadRemitenteID" },
                values: new object[,]
                {
                    { new Guid("a22533a6-7621-492c-b10b-a9363668a2f4"), true, "4OMrm+P3jNpf7pTqrqf8aWCZ/TJgqfaI1LkxFvHu13E=", "angel@gmail.com", "Angel Sayago Arcos", new Guid("a7c2766f-c09e-41a1-b6e4-35aeed3ad8e7"), new Guid("88f8cf91-458b-438c-b882-75a842387c64"), new Guid("dec844ee-a2ba-4a09-a4e1-62a5ea6a46b7") },
                    { new Guid("1139861b-5044-4257-b89a-db1b5d4402bf"), true, "4OMrm+P3jNpf7pTqrqf8aWCZ/TJgqfaI1LkxFvHu13E=", "root@root.com", "root", new Guid("77a225a3-1266-4b1f-b11c-504969afa856"), new Guid("88f8cf91-458b-438c-b882-75a842387c64"), new Guid("8a8e1e09-f9ce-41cb-b0b2-4ef91f7b4d61") },
                    { new Guid("7467db95-c0a1-41df-a844-bbb00b60b952"), true, "4OMrm+P3jNpf7pTqrqf8aWCZ/TJgqfaI1LkxFvHu13E=", "administrador@administrador.com", "Administrador", new Guid("9a39bcce-b092-4f90-9de7-9e0fb2137034"), new Guid("88f8cf91-458b-438c-b882-75a842387c64"), new Guid("8a8e1e09-f9ce-41cb-b0b2-4ef91f7b4d61") },
                    { new Guid("03147300-43fc-4294-81d4-4bc08366f4a4"), true, "4OMrm+P3jNpf7pTqrqf8aWCZ/TJgqfaI1LkxFvHu13E=", "fiscal@gmail.com", "Fiscal Mario", new Guid("39b991ab-e83e-4441-9638-9bd8fa647cb5"), new Guid("88f8cf91-458b-438c-b882-75a842387c64"), new Guid("8a8e1e09-f9ce-41cb-b0b2-4ef91f7b4d61") },
                    { new Guid("2e3ff721-5a7d-4b82-87bb-3a593824ce25"), true, "4OMrm+P3jNpf7pTqrqf8aWCZ/TJgqfaI1LkxFvHu13E=", "magali@gmail.com", "Magali Herrera Ramirez", new Guid("942f1900-7987-4820-a40b-7f4b78099d85"), new Guid("4f0f5406-572d-409c-8cf2-4add53fceb78"), new Guid("8ecec734-2171-4bec-aaec-eba010af2489") }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Quejas_UnidadRemitenteID",
                table: "Quejas",
                column: "UnidadRemitenteID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Usuarios_UnidadRemitenteID",
                table: "Usuarios",
                column: "UnidadRemitenteID");
        }
