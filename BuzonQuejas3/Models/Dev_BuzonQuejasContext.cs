...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Usuario>().HasData(new Usuario { UsuarioID = new Guid("a22533a6-7621-492c-b10b-a9363668a2f4"), Nombre = "Angel Sayago Arcos", Correo="angel@gmail.com", Clave = "123", Activo = true, RolID = Guid.Parse("a7c2766f-c09e-41a1-b6e4-35aeed3ad8e7"), DepartamentoID= Guid.Parse("dec844ee-a2ba-4a09-a4e1-62a5ea6a46b7"), UnidadAdministrativaID = Guid.Parse("88f8cf91-458b-438c-b882-75a842387c64") });
            ...
            modelBuilder.Entity<Usuario>().HasData(new Usuario { UsuarioID = new Guid("03147300-43fc-4294-81d4-4bc08366f4a4"), Nombre = "Fiscal Mario", Correo="fiscal@gmail.com", Clave = "123", Activo = true, RolID = Guid.Parse("39b991ab-e83e-4441-9638-9bd8fa647cb5"), DepartamentoID= Guid.Parse("8a8e1e09-f9ce-41cb-b0b2-4ef91f7b4d61"), UnidadAdministrativaID = Guid.Parse("88f8cf91-458b-438c-b882-75a842387c64") });
